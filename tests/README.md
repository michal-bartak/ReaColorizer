...
| Suite | Runs | Covers |
|---|---|---|
| `MXM_AutoColor_RunTests.lua` (repo root) | in REAPER **and** standalone | regex engine, matcher, predicates, colours, JSON, rules, config, the whole `apply` decision layer |
