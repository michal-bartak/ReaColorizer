...
ReaColorizer colours **tracks, items, regions and markers** in REAPER from their **names**, using
...
[Matching names](/ReaColorizer/usage/matching/) covers what the three modes do differently. Do not
run both at once — see [Troubleshooting](/ReaColorizer/troubleshooting/).
:::
...
- [Troubleshooting](/ReaColorizer/troubleshooting/) — when the colour is not what you expected.
